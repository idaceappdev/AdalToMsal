...
- The fourth folder [4. Nice-Todo-Webapp-webapi-MSAL](4.%20Nice-Todo-Webapp-webapi-MSAL) has a readme and code snippet which are nice to do thingsleveraging the full capabilities of Microsoft.Identity.Web & MSAL   
